    ...
    return (
        ...
        overflow-hidden sm:right-10 sm:w-[60%] 3xl:top-[400px]">
            ...
            <div className="relative flex h-96 flex-col items-center justify-center gap-10 rounded-b-lg border-t-0 bg-secondary pb-5 drop-shadow-lg backdrop-blur-lg xl:h-[520px]">
                ...
                <div className='z-50'>
                    <HomeButton title='Minimalist' link='/simple' description='More Simple Portafolio' color='bg-accent' />
                </div>
                <HomeButton title='Contact Me' link='/contact/contacting' description='I Answer quickly :)' color='bg-white' />
